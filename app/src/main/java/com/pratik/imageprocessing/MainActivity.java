...
public class MainActivity extends AppCompatActivity {
    ...
    private BluetoothDevice device1;
     ...
     private MyBluetoothService.ConnectedThread myBluetoothService;
    ...
    private void checkReqBT(BluetoothDevice device){
            ...
            device1 = device;
            if(device1.getName().equals("HC-05") || device1.getName().equals("HC-06") ){
    ...
    public void onSubmit(View view) {
        ...
        BluetoothSocket bluetoothSocket = connectThread.mmSocket;
        myBluetoothService = new MyBluetoothService.ConnectedThread(bluetoothSocket);
        String m = editText.getText().toString();
        char message[] = new char[100];
        for(int i =0; i<m.length();i++)
        message[i] =  editText.getText().charAt(i);
        myBluetoothService.write(m);
